  ...
  <div class="gi_table_page">
    ...
    >
      ...
      <template #toolbar-right>
        <a-button v-permission="['training:orgTrainingPrice:add']" type="primary" @click="onAdd">
          <template #icon><icon-plus /></template>
          <template #default>新增</template>
        </a-button>
        <a-button v-permission="['training:orgTrainingPrice:export']" @click="onExport">
    ...
    <OrgTrainingPriceAddModal ref="OrgTrainingPriceAddModalRef" @save-success="search" />
...
import { type OrgTrainingPriceResp, type OrgTrainingPriceQuery, deleteOrgTrainingPrice, exportOrgTrainingPrice, listOrgTrainingPrice } from '@/apis/training/orgTrainingPrice'
...
const columns = ref<TableInstanceColumns[]>([
  ...
  { title: '是否删除（0否，1是）', dataIndex: 'isDeleted', slotName: 'isDeleted' },
  {
    ...
    show: has.hasPermOr(['training:orgTrainingPrice:detail', 'training:orgTrainingPrice:update', 'training:orgTrainingPrice:delete'])
  }
]);
...
const OrgTrainingPriceAddModalRef = ref<InstanceType<typeof OrgTrainingPriceAddModal>>()
// 新增
const onAdd = () => {
...
const OrgTrainingPriceDetailDrawerRef = ref<InstanceType<typeof OrgTrainingPriceDetailDrawer>>()
// 详情
